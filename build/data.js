...
var LL_ARTISTS = [_llMk("llw1", "Barely Alive", "Dubstep", 2, 1), _llMk("llw2", "Calcium B2B Mad Dubz", "Bass", 2, 1), _llMk("llw3", "Caspa", "Dubstep", 2, 1), _llMk("llw4", "Chassi", "Bass", 2, 1), _llMk("llw5", "Distinct Motive", "Deep Dubstep", 2, 1), _llMk("llw6", "Emorfik B2B Usaybflow", "Bass", 2, 1), _llMk("llw7", "Gardella", "Bass", 2, 1), _llMk("llw8", "Hairitage", "Bass", 2, 1), _llMk("llw9", "Hershe", "Bass", 2, 1), _llMk("llw10", "Hydraulix", "Bass", 2, 1), _llMk("llw11", "Izzy Vadim", "Bass", 2, 1), _llMk("llw12", "Jaenga", "Bass", 2, 1), _llMk("llw13", "Mile32", "Bass", 2, 1), _llMk("llw14", "MPORT", "Bass", 2, 1), _llMk("llw15", "Muerte", "Bass", 2, 1), _llMk("llw16", "Nikita, The Wicked", "Bass", 2, 1), _llMk("llw17", "Riot Ten", "Dubstep", 2, 1), _llMk("llw18", "Smoakland", "Bass", 2, 1), _llMk("llh1", "Alienpark", "Bass", 2, 2), _llMk("llh2", "Deadcrow", "Bass", 2, 2), _llMk("llh3", "Dirt Monkey", "Dubstep", 2, 2), _llMk("llh4", "Funtcase", "Dubstep", 2, 2), _llMk("llh5", "Machaki", "Bass", 2, 2), _llMk("llh6", "MEGA B2B2B2B PRE-PARTY", "Bass", 3, 2), _llMk("llh7", "Mindset", "Bass", 2, 2), _llMk("llh8", "Phrva", "Bass", 2, 2), _llMk("llh9", "Rsun", "Bass", 2, 2), _llMk("llh10", "RZRKT", "Bass", 2, 2), _llMk("llh11", "Super Future", "Space Bass", 2, 2), _llMk("llh12", "Zen Selekta", "Bass", 2, 2), _llMk("llf1", "$J", "Bass", 1, 3), _llMk("llf2", "Austeria", "Bass", 1, 3), _llMk("llf3", "Badklaat", "Bass", 1, 3), _llMk("llf4", "Basstripper", "Bass", 1, 3), _llMk("llf5", "Bear Grillz", "Dubstep", 2, 3), _llMk("llf6", "Benda", "Bass", 1, 3), _llMk("llf7", "Borgore", "Dubstep", 2, 3), _llMk("llf8", "Canabliss", "Bass", 1, 3), _llMk("llf9", "Casey Club", "Bass", 1, 3), _llMk("llf10", "Crizzly", "Dubstep", 2, 3), _llMk("llf11", "Dion Timmer", "Dubstep", 2, 3), _llMk("llf12", "Dirtysnatcha", "Bass", 1, 3), _llMk("llf13", "Doctor P", "Dubstep", 2, 3), _llMk("llf14", "Dodge & Fuski", "Dubstep", 2, 3), _llMk("llf15", "Dr. Ushuu", "Bass", 1, 3), _llMk("llf16", "Drinkurwater", "Bass", 1, 3), _llMk("llf17", "Dubscribe", "Bass", 1, 3), _llMk("llf60", "Excision (2 Hour Set)", "Dubstep", 3, 3), _llMk("llf18", "Future Exit", "Bass", 1, 3), _llMk("llf19", "HOL!", "Dubstep", 2, 3), _llMk("llf20", "Infekt B2B Samplifire", "Riddim", 2, 3), _llMk("llf21", "Ivy Lab", "Drum & Bass", 2, 3), _llMk("llf22", "Izadi", "Bass", 1, 3), _llMk("llf23", "Jantsen", "Dubstep", 2, 3), _llMk("llf24", "Jkyl & Hyde", "Bass", 1, 3), _llMk("llf25", "Kliptic", "Dubstep", 2, 3), _llMk("llf26", "Klo", "Dubstep", 2, 3), _llMk("llf27", "Lazrus", "Dubstep", 2, 3), _llMk("llf28", "Levity", "Dubstep", 2, 3), _llMk("llf29", "Liquid Stranger", "Space Bass", 2, 3), _llMk("llf30", "Lumasi", "Bass", 1, 3), _llMk("llf31", "Neumonic", "Bass", 2, 3), _llMk("llf32", "Nghtmre", "Trap / Future Bass", 3, 3), _llMk("llf33", "Nimda", "Bass", 1, 3), _llMk("llf34", "Oliverse", "Bass", 1, 3), _llMk("llf35", "Paper Skies", "Melodic Bass", 2, 3), _llMk("llf36", "Pegboard Nerds", "Electro / Dubstep", 2, 3), _llMk("llf37", "Poni", "Bass", 1, 3), _llMk("llf38", "Probcause", "Bass", 1, 3), _llMk("llf39", "Ravenscoon", "Dubstep", 2, 3), _llMk("llf40", "Reaper", "Dubstep", 2, 3), _llMk("llf41", "Richard Finger", "Bass", 1, 3), _llMk("llf42", "Riot", "Drum & Bass", 2, 3), _llMk("llf43", "Seth David", "Bass", 1, 3), _llMk("llf44", "Shlump", "Space Bass", 2, 3), _llMk("llf45", "Sigma", "Drum & Bass", 2, 3), _llMk("llf46", "Sippy", "Dubstep", 2, 3), _llMk("llf47", "Subsonic", "Bass", 1, 3), _llMk("llf48", "Sullivan King B2B Ray Volpe", "Rocktronic / Riddim", 3, 3), _llMk("llf49", "The Resistance", "Dubstep", 2, 3), _llMk("llf50", "The Widdler", "Dubstep", 2, 3), _llMk("llf51", "Twopercent", "Bass", 1, 3), _llMk("llf52", "TYNAN", "Bass", 1, 3), _llMk("llf53", "Vampa", "Dubstep", 2, 3), _llMk("llf54", "VKTM", "Bass", 1, 3), _llMk("llf55", "Wiley", "Space Bass", 2, 3), _llMk("llf56", "Wooli (Sunset Set)", "Dubstep / Melodic Bass", 3, 3), _llMk("llf57", "Xotix", "Bass", 1, 3), _llMk("llf58", "YOOKIE", "Dubstep / Hybrid", 2, 3), _llMk("llf59", "Zero", "Bass", 1, 3), _llMk("lls1", "2DY4", "Bass", 1, 4), _llMk("lls2", "AEON:MODE B2B Blossom", "Bass", 1, 4), _llMk("lls3", "All The Reason", "Bass", 1, 4), _llMk("lls4", "Au5", "Melodic Dubstep", 2, 4), _llMk("lls5", "Audiofreq", "Bass", 1, 4), _llMk("lls6", "Bella Renee", "Bass", 1, 4), _llMk("lls7", "Big Florida", "Bass", 1, 4), _llMk("lls8", "Bou", "Drum & Bass", 2, 4), _llMk("lls9", "Brainrack", "Bass", 1, 4), _llMk("lls10", "Capochino", "Bass", 1, 4), _llMk("lls11", "Chozen", "Bass", 1, 4), _llMk("lls13", "Craze B2B Dieselboy", "Bass", 1, 4), _llMk("lls14", "Crumb Pit", "Riddim", 2, 4), _llMk("lls15", "Cyclops", "Bass", 1, 4), _llMk("lls16", "Darksiderz B2B Madgrrl", "Bass", 1, 4), _llMk("lls17", "Delta Heavy", "Drum & Bass", 2, 4), _llMk("lls18", "Dirtyphonics", "Drum & Bass", 2, 4), _llMk("lls19", "Dr. Fresch", "Bass House", 3, 4), _llMk("lls20", "Effin", "Bass", 1, 4), _llMk("lls21", "Flosstradamus", "Trap", 3, 4), _llMk("lls22", "Flux Pavilion", "Dubstep", 3, 4), _llMk("lls23", "Ganja White Night", "Dubstep", 3, 4), _llMk("lls24", "GHENGAR", "Dubstep", 2, 4), _llMk("lls25", "Gladde Paling", "Bass", 1, 4), _llMk("lls26", "Green Matter", "Bass", 1, 4), _llMk("lls27", "Hedex", "D&B / Jump-Up", 2, 4), _llMk("lls28", "Heyz", "Dubstep / House", 2, 4), _llMk("lls29", "HVDES", "Bass", 1, 4), _llMk("lls30", "Illenium", "Melodic Bass", 3, 4), _llMk("lls31", "Imanu", "Drum & Bass", 2, 4), _llMk("lls32", "Ivory", "Dubstep", 2, 4), _llMk("lls33", "Jessica Audiffred", "Dubstep", 3, 4), _llMk("lls34", "Josh Teed", "Bass", 1, 4), _llMk("lls35", "Kai Wachi", "Dubstep", 3, 4), _llMk("lls36", "Layz", "Dubstep", 2, 4), _llMk("lls37", "Leotrix", "Future Riddim", 2, 4), _llMk("lls38", "Lil Texas", "Bass", 1, 4), _llMk("lls39", "Lowcation", "Bass", 1, 4), _llMk("lls40", "Mefjus + Daxta MC", "Drum & Bass", 2, 4), _llMk("lls41", "Mozey", "Drum & Bass", 2, 4), _llMk("lls42", "Myrias", "Bass", 1, 4), _llMk("lls43", "Mythm", "Bass", 1, 4), _llMk("lls44", "Neotek", "Bass", 1, 4), _llMk("lls45", "Noetika", "Bass", 1, 4), _llMk("lls46", "Phaseone", "Metalstep", 2, 4), _llMk("lls47", "Prosecute", "Dubstep", 2, 4), _llMk("lls48", "Saint Miller", "Bass", 2, 4), _llMk("lls49", "Seven Lions (Sunset Set)", "Melodic Bass", 3, 4), _llMk("lls50", "Slander", "Melodic Bass", 3, 4), _llMk("lls51", "Space Wizard", "Bass", 1, 4), _llMk("lls52", "Stoned Level", "Bass", 1, 4), _llMk("lls53", "Subtronics B2B Level Up", "Riddim / Dubstep", 3, 4), _llMk("lls54", "Tisoki", "Dubstep", 2, 4), _llMk("lls55", "Tokyo Machine", "Electro House", 3, 4), _llMk("lls56", "Truth", "Deep Dubstep", 2, 4), _llMk("lls57", "Whales", "Bass", 1, 4), _llMk("lls58", "Whethan", "Future Bass", 3, 4), _llMk("lls59", "Wraz", "Bass", 1, 4), _llMk("lls60", "Zingara", "Bass", 1, 4), _llMk("lls61", "Zomboy", "Dubstep", 3, 4), _llMk("llu1", "Adventure Club (Throwback Set)", "Melodic Dubstep", 2, 5), _llMk("llu3", "Arlo", "Bass", 2, 5), _llMk("llu4", "Armnhmr", "Melodic Bass", 2, 5), _llMk("llu5", "Atliens", "Bass", 2, 5), _llMk("llu6", "Avello", "Bass", 1, 5), _llMk("llu7", "Boogie T", "Bass", 1, 5), _llMk("llu8", "Champagne Drip", "Space Bass", 2, 5), _llMk("llu9", "Codd Dubz", "Bass", 1, 5), _llMk("llu2", "Crankdat B2B Alleycvt", "Bass", 1, 5), _llMk("llu10", "Crystal Skies", "Melodic Dubstep", 2, 5), _llMk("llu11", "Distant Matter", "Bass", 1, 5), _llMk("llu12", "Dream Takers", "Bass", 1, 5), _llMk("llu13", "Eptic B2B LYNY", "Dubstep", 3, 5), _llMk("llu14", "Excision (Detox)", "Dubstep", 3, 5), _llMk("llu15", "Excision B2B Space Laces", "Dubstep", 3, 5), _llMk("llu16", "FINNUH", "Bass", 1, 5), _llMk("llu17", "Ghastly", "Bass", 2, 5), _llMk("llu18", "Grabbitz", "Electronic / Rock", 3, 5), _llMk("llu19", "Haliene", "Melodic Bass", 2, 5), _llMk("llu20", "Hostage Situation", "Bass", 2, 5), _llMk("llu21", "Hurtbox", "Riddim", 2, 5), _llMk("llu22", "Killmatter", "Bass", 1, 5), _llMk("llu23", "Know Good", "Bass", 1, 5), _llMk("llu24", "Kompany", "Dubstep", 3, 5), _llMk("llu25", "Krewella", "Electro / Bass", 3, 5), _llMk("llu26", "Luci", "Pop / Electronic", 2, 5), _llMk("llu27", "Mad Dubz", "Bass", 1, 5), _llMk("llu28", "Modal Nodes", "Bass", 1, 5), _llMk("llu29", "OG NIXIN", "Bass", 1, 5), _llMk("llu30", "Onara", "Bass", 1, 5), _llMk("llu31", "Passport", "Bass", 1, 5), _llMk("llu32", "Pretty Sweet", "Bass", 1, 5), _llMk("llu33", "Remk", "Bass", 1, 5), _llMk("llu34", "ROI*", "Bass", 1, 5), _llMk("llu35", "Ryns", "Bass", 1, 5), _llMk("llu36", "Sisto", "House", 2, 5), _llMk("llu37", "Skilah", "Bass", 1, 5), _llMk("llu38", "Sodown", "Bass", 1, 5), _llMk("llu39", "Sportmode", "House", 2, 5), _llMk("llu40", "SQISHI", "Bass", 1, 5), _llMk("llu41", "Stumpi", "Bass", 1, 5), _llMk("llu42", "Taiki Nulight", "Bass House", 2, 5), _llMk("llu43", "Trivecta", "Melodic Bass", 2, 5), _llMk("llu44", "Usaybflow", "Riddim", 2, 5), _llMk("llu45", "Virtual Riot", "Dubstep", 3, 5), _llMk("llu46", "Warlord", "Bass", 1, 5), _llMk("llu47", "Wax Motif", "Bass House", 2, 5), _llMk("llu48", "William Black", "Melodic Bass", 2, 5), _llMk("llu49", "Wonkywilla", "Dubstep", 2, 5), _llMk("llu50", "Yetep", "Melodic Bass", 2, 5), _llMk("llu51", "YVM3", "Dubstep", 2, 5), _llMk("llu52", "Zoey808", "Bass", 1, 5)];
var LL_AMENITIES = [{
  id: "lla1",
  type: "water",
  label: "Free Water",
