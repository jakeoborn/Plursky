...
const EDCO_ARTISTS = [
  _edcoMk("ecf1", "AAT",                                      "Electronic", 1),
  _edcoMk("ecf2", "Adventure Club (Sunset Set)",              "Electronic", 1),
  _edcoMk("ecf3", "Afrojack",                                 "Electronic", 1),
  _edcoMk("ecf4", "Alesso (Sunset Set)",                      "Electronic", 1),
  _edcoMk("ecf5", "Azzecca",                                  "House", 1),
  _edcoMk("ecf6", "Benda B2B Vastive",                        "Electronic", 1),
  _edcoMk("ecf7", "Big Florida",                              "Bass", 1),
  _edcoMk("ecf8", "Bou B2B Kanine",                           "Electronic", 1),
  _edcoMk("ecf9", "Brunello (Sunset Set)",                    "House", 1),
  _edcoMk("ecf10", "Bullet Tooth B2B Sidney Charles",          "Techno", 1),
  _edcoMk("ecf11", "Chris Lorenzo",                            "House", 1),
  _edcoMk("ecf12", "David Guetta",                             "Electronic", 1),
  _edcoMk("ecf13", "HAYLA",                                    "Electronic", 1),
  _edcoMk("ecf14", "IDEMI",                                    "Electronic", 1),
  _edcoMk("ecf15", "Inbal",                                    "Electronic", 1),
  _edcoMk("ecf16", "Interplanetary Criminal",                  "Electronic", 1),
  _edcoMk("ecf17", "JOA",                                      "Electronic", 1),
  _edcoMk("ecf18", "Josh Baker",                               "House", 1),
  _edcoMk("ecf19", "Joshwa",                                   "House", 1),
  _edcoMk("ecf20", "Kompany",                                  "Bass", 1),
  _edcoMk("ecf21", "KREAM",                                    "Electronic", 1),
  _edcoMk("ecf22", "Level Up",                                 "Bass", 1),
  _edcoMk("ecf23", "Levity",                                   "Bass", 1),
  _edcoMk("ecf24", "MALUGI (Sunset Set)",                      "Electronic", 1),
  _edcoMk("ecf25", "Matthias",                                 "Electronic", 1),
  _edcoMk("ecf26", "Mau P",                                    "Electronic", 1),
  _edcoMk("ecf27", "MPH",                                      "Electronic", 1),
  _edcoMk("ecf28", "Omar+",                                    "House", 1),
  _edcoMk("ecf29", "Pegassi",                                  "Electronic", 1),
  _edcoMk("ecf30", "Prospa B2B Josh Baker",                    "House", 1),
  _edcoMk("ecf31", "Prospa",                                   "Electronic", 1),
  _edcoMk("ecf32", "RAJE",                                     "Electronic", 1),
  _edcoMk("ecf33", "Sloth",                                    "Electronic", 1),
  _edcoMk("ecf34", "Whethan",                                  "Electronic", 1),
  _edcoMk("ecf35", "Wooli",                                    "Bass", 1),
  _edcoMk("ecf36", "Zack Martino",                             "Electronic", 1),
  _edcoMk("ecs1", "Aaron Hibell",                             "Electronic", 2),
  _edcoMk("ecs2", "ACRAZE B2B CID",                           "Electronic", 2),
  _edcoMk("ecs3", "Alan Walker (Sunset Set)",                 "Electronic", 2),
  _edcoMk("ecs4", "Alison Wonderland",                        "Bass", 2),
  _edcoMk("ecs5", "ALLEYCVT",                                 "Bass", 2),
  _edcoMk("ecs6", "Alves",                                    "Electronic", 2),
  _edcoMk("ecs7", "AVELLO",                                   "Electronic", 2),
  _edcoMk("ecs8", "AYYBO",                                    "Electronic", 2),
  _edcoMk("ecs9", "ChaseWest",                                "Electronic", 2),
  _edcoMk("ecs10", "Dennis Cruz",                              "House", 2),
  _edcoMk("ecs11", "Devault (Sunset Set)",                     "Electronic", 2),
  _edcoMk("ecs12", "Discip",                                   "Electronic", 2),
  _edcoMk("ecs13", "Disco Lines",                              "Electronic", 2),
  _edcoMk("ecs14", "Fallon",                                   "Electronic", 2),
  _edcoMk("ecs15", "Franky Rizardo",                           "House", 2),
  _edcoMk("ecs16", "Fury with MC Dino",                        "Electronic", 2),
  _edcoMk("ecs17", "Gabss",                                    "Electronic", 2),
  _edcoMk("ecs18", "Greg 99",                                  "Electronic", 2),
  _edcoMk("ecs19", "Jkyl & Hyde",                              "Bass", 2),
  _edcoMk("ecs20", "Kaskade",                                  "Electronic", 2),
  _edcoMk("ecs21", "KinAhau",                                  "House", 2),
  _edcoMk("ecs22", "LAYZ",                                     "Bass", 2),
  _edcoMk("ecs23", "MADVKTM",                                  "Electronic", 2),
  _edcoMk("ecs24", "Mai Iachetti",                             "Electronic", 2),
  _edcoMk("ecs25", "Max Dean, Luke Dean",                      "Electronic", 2),
  _edcoMk("ecs26", "Me n ü",                                   "Electronic", 2),
  _edcoMk("ecs27", "Miguelle & Tons",                          "Electronic", 2),
  _edcoMk("ecs28", "Monoky",                                   "Electronic", 2),
  _edcoMk("ecs29", "Nico Moreno",                              "Techno", 2),
  _edcoMk("ecs30", "Ray Volpe",                                "Bass", 2),
  _edcoMk("ecs31", "Roddy Lima",                               "Electronic", 2),
  _edcoMk("ecs32", "Rossi. (Sunset Set)",                      "House", 2),
  _edcoMk("ecs33", "Skull Machine (Black Tiger Sex Machine x Kai Wachi)", "Electronic", 2),
  _edcoMk("ecs34", "Steve Aoki",                               "Electronic", 2),
  _edcoMk("ecs35", "Subsonic",                                 "Electronic", 2),
  _edcoMk("ecs36", "Twinsick",                                 "Electronic", 2),
  _edcoMk("ecu1", "A Little Sound",                           "Electronic", 3),
  _edcoMk("ecu2", "Adrián Mills",                             "Techno", 3),
  _edcoMk("ecu3", "Alok",                                     "Electronic", 3),
  _edcoMk("ecu4", "AR/CO",                                    "Electronic", 3),
  _edcoMk("ecu5", "ATLiens",                                  "Bass", 3),
  _edcoMk("ecu6", "Boogie T",                                 "Bass", 3),
  _edcoMk("ecu7", "Boys Noize B2B Brutalismus 3000",          "Techno", 3),
  _edcoMk("ecu8", "Chef Boyarbeatz",                          "Electronic", 3),
  _edcoMk("ecu9", "CØNTRA",                                   "Electronic", 3),
  _edcoMk("ecu10", "Deorro B2B DJ Diesel",                     "Electronic", 3),
  _edcoMk("ecu11", "Discovery Project",                        "Electronic", 3),
  _edcoMk("ecu12", "ESSE",                                     "Electronic", 3),
  _edcoMk("ecu13", "Hardwell",                                 "Electronic", 3),
  _edcoMk("ecu14", "Holy Priest",                              "Electronic", 3),
  _edcoMk("ecu15", "I Hate Models",                            "Techno", 3),
  _edcoMk("ecu16", "Ian Asher",                                "Electronic", 3),
  _edcoMk("ecu17", "Jessica Audiffred",                        "Bass", 3),
  _edcoMk("ecu18", "Kaivon",                                   "Bass", 3),
  _edcoMk("ecu19", "KI/KI",                                    "Techno", 3),
  _edcoMk("ecu20", "Klangkuenstler",                           "Techno", 3),
  _edcoMk("ecu21", "Know Good",                                "Electronic", 3),
  _edcoMk("ecu22", "M81!",                                     "Electronic", 3),
  _edcoMk("ecu23", "Maddix",                                   "Electronic", 3),
  _edcoMk("ecu24", "Marlon Hoffstadt (Sunset Set)",            "Techno", 3),
  _edcoMk("ecu25", "Martin Garrix",                            "Electronic", 3),
  _edcoMk("ecu26", "Meduza",                                   "Electronic", 3),
  _edcoMk("ecu27", "Of The Trees (Sunset Set)",                "Bass", 3),
  _edcoMk("ecu28", "phrva",                                    "Electronic", 3),
  _edcoMk("ecu29", "Ravenscoon",                               "Electronic", 3),
  _edcoMk("ecu30", "San Holo (Wholesome Riddim Set)",          "Electronic", 3),
  _edcoMk("ecu31", "SHDW",                                     "Techno", 3),
  _edcoMk("ecu32", "Sippy",                                    "Bass", 3),
  _edcoMk("ecu33", "SLANDER (Sunset Set)",                     "Bass", 3),
...
// wompy-woods, 29 crater, 23 prehistoric - and NONE of that split was
// published. It was inferred from tier and day, then rendered as fact: the
// lineup screen drew a stage chip in that stage's colour, the map filtered
// by it, and only an artist-bio string said "provisional".
//
// The split was not merely unsourced, it was CONTRADICTED. Checked
// 2026-09-07: lostlandsfestival.com/lineup/ publishes two lineup graphics
// (main days + early entry) and no stage breakdown at all, and published
// coverage of the early-entry pre-party names THREE stages - Prehistoric,
// The Crater AND The Grove - where this data had Wednesday and Thursday
// entirely on The Crater. It also names ~11 Grove artists (Caspa, Dirt
// Monkey, Distinct Motive, HerShe, Hydraulix, Jaenga, Nikita The Wicked,
// Phrva, Smoakland, Super Future, Zen Selekta) that this file had on The
// Crater - which is also why The Grove and Raptor Alley read as "zero acts,
// probably an artifact". They were not an artifact. The acts were on the
// wrong stage.
//
// So: stage null for every act, which is the house form for an unpublished
// stage (III Points 218 acts, Escape Halloween 83). LL_STAGES keeps all
...
const LL_ARTISTS = [
  ...
  _llMk("llw12", "Jaenga", "Bass", 2, 1),
  _llMk("llw13", "Mile32", "Bass", 2, 1),
  _llMk("llw14", "MPORT", "Bass", 2, 1),
  _llMk("llw15", "Muerte", "Bass", 2, 1),
  ...
  _llMk("llf10", "Crizzly", "Dubstep", 2, 3),
  ...
  _llMk("llu30", "Onara", "Bass", 1, 5),
  _llMk("llu31", "Passport", "Bass", 1, 5),
  _llMk("llu32", "Pretty Sweet", "Bass", 1, 5),
